...
1. サイドバーから「タスク1」タブを押して開いてください。タブを開くと3つのニュース記事のタイトルが表示されます。タイトルを押して、ニュース記事の内容と、その記事につけられたコメントを確認してください。画面の見方の詳細については、「タスク画面の説明」の項目を参照してください。
2. 「質問回答」タブを開いて、表示される質問にそって回答してください。回答内容はタブを切り替えても一時的に保存されます。必要に応じて適宜タブを切り替え、タスクの内容を確認しながら回答してください。
3. 「タスク2」タブを開いて、1.と同様に表示される3つのニュース記事を確認し、「質問回答」タブから回答してください。
...
"画面の構成は以下のようになっています。")
image = Image.open('https://github.com/meg-github/hatena_gui_hawk/tree/main/hawk/fig_exp.png')
